    ...
    <div className="flex h-screen bg-[#050505] text-[#ECECEC] font-sans selection:bg-[#BEFF00]/30 overflow-hidden relative">
      ...
      <div className={`${isSidebarOpen ? 'w-[280px]' : 'w-0'} shrink-0 bg-[#111111]/80 backdrop-blur-3xl border-r border-[#BEFF00]/10 flex flex-col transition-all duration-300 overflow-hidden z-20 shadow-2xl`}>
         ...
         <div className="flex-1 overflow-y-auto custom-scrollbar px-3 pb-4">
            ...
            {history.length === 0 ? (
              <div className="text-center p-4 text-gray-500/70 text-sm">
                No saved logs yet.
              </div>
            ) : (
              <div className="space-y-1.5">
                {history.map(item => (
                  <div 
                    ...
                    className="group relative flex items-center p-3 rounded-xl hover:bg-white/5 cursor-pointer transition-all border border-transparent hover:border-white/5"
                  >
                    ...
                    <button 
                      ...
                      className="absolute right-3 opacity-0 group-hover:opacity-100 p-1.5 text-gray-400 hover:text-red-400 hover:bg-red-500/10 rounded-lg transition-all"
                      title="Delete log"
                    >
